(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-collections-collections-module~components-items-items-module"], {
    ...
    /***/
    function IgIN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "GridskeletonModule", function () {
        return GridskeletonModule;
      });
      /* harmony import */
      ...
      var _gridskeleton_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      */
      ...
      var GridskeletonModule = function GridskeletonModule() {
        _classCallCheck(this, GridskeletonModule);
      };

      GridskeletonModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: GridskeletonModule
      });
      GridskeletonModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function GridskeletonModule_Factory(t) {
          return new (t || GridskeletonModule)();
        },
        providers: [],
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](GridskeletonModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GridskeletonModule, [{
    ...
    function swHO(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "GridskeletonComponent", function () {
        return GridskeletonComponent;
      });
      /* harmony import */
      ...
      */
      ...
      function GridskeletonComponent_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var GridskeletonComponent = /*#__PURE__*/function () {
        function GridskeletonComponent() {
          _classCallCheck(this, GridskeletonComponent);

          this.collections = [1, 2, 3, 4];
        }

        _createClass(GridskeletonComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      GridskeletonComponent.ɵfac = function GridskeletonComponent_Factory(t) {
        return new (t || GridskeletonComponent)();
      };

      GridskeletonComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: GridskeletonComponent,
        selectors: [["app-gridskeleton"]],
        decls: 2,
        vars: 1,
        consts: [[1, "row"], ["class", "col-md-3", 4, "ngFor", "ngForOf"], [1, "col-md-3"], [1, "collectionItem"], [1, "collectionItemImg"], ["count", "1", 3, "theme"], [1, "collectionItemTitle"], [1, "collectionItemCount"]],
        template: function GridskeletonComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GridskeletonComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
...
//# sourceMappingURL=default~components-collections-collections-module~components-items-items-module-es5.js.map